...
#        print("Queue = ", queue)
        ...
        if current_node != start:
            current_node_cost = current_node_cost - distance_func(current_node, goal)
...
#            print("Run loop for = ", next_node)
            ...
            if next_node not in visited:
                ...
                estimated_cost = distance_func(next_node, goal)
#                print("\nEstimated cost = ", estimated_cost)
                step_cost = cost_of_step(current_node, next_node)
                total_cost = estimated_cost + current_node_cost + step_cost
...
def cost_of_step(point1, point2):
    x1, y1 = point1
    x2, y2 = point2
    if x1 == x2:
        return 1
